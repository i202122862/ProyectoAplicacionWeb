...
public class EmployeeExporterExcel implements InterfaceExporterExcel{

    private XSSFWorkbook libro;
    private XSSFSheet hoja;
    private List<Employee> listaPersonas;

    public EmployeeExporterExcel(List<Employee> listaPersonas) {
    ...
    public void escribirDatosDeLaTabla() {
        ...
        for(Employee persona : listaPersonas) {
            Row fila = hoja.createRow(numeroFilas++);

            Cell celda = fila.createCell(0);
            celda.setCellValue(persona.getEmployeeId());
            ...
            celda = fila.createCell(2);
            celda.setCellValue(persona.getPosition());
