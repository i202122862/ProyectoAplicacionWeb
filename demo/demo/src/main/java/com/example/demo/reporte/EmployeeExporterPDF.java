...
public class EmployeeExporterPDF implements InterfaceExporterPDF{

    private List<Employee> listaPersonas;

    public EmployeeExporterPDF(List<Employee> listaPersonas) {
    ...
    public void escribirDatosDeLaTabla(PdfPTable tabla) {
        ...
        for(Employee persona : listaPersonas) {
            tabla.addCell(String.valueOf(persona.getEmployeeId()));
            tabla.addCell(persona.getName());
            tabla.addCell(persona.getPosition());
