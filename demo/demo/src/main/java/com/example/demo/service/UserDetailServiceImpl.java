...
public class UserDetailServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        UserEntity userDetails=userToaRepository.findByUsername(username)
        ...
        //aquí se define si el usuario esta activo, credenciales expirdas y reoles role_admin, role_etc
